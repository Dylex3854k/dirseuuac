...
$sel = $con->query("SELECT * FROM evento 
        ...
        LEFT JOIN voluntariado ON gestion_reporte.gest_rep_id = voluntariado.gest_rep_id;" );
?>
...
<div class="image-grid">
    ...
    <div class="image-slot">
        ...
        <form class="form" action="../voluntariado/formulario.php" method="post">
            <input type="hidden" name="voluntariado_id" value="<?php echo $f['voluntariado_id']; ?>">
